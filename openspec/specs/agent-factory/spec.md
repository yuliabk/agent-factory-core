...
Define the governance baseline that keeps Agent Factory implementation specification-approved, limited to safe MVP data, and restricted to reviewed external skills.
